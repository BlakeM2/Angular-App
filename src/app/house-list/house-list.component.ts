  ...
  houseList: Houseinfo[] = [
    {
      ...
      city: 'Boulder',
      state: 'Colorado',
      photo: "../assets/Australia.jpg",
      subphoto1: "../assets/1Australia.jpg",
      subphoto2: "../assets/2Australia.jpg",
      subphoto3: "../assets/3Australia.jpg",
      subphoto4: "../assets/4Australia.jpg",
      price: 900000,
      rent: false,
      utilities: false,
